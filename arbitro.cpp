...
void Arbitro::iniciarJuego()
{
    ...
    while (!juegoEnCurso)
    {
        ...
        cout<< "Ingresa el tama\xA4o del tablero de juego: "<< endl;//imprimira el tamaño del cual queremos nuestro tablero de juego "dimension"
        if (fgets (letra, sizeof letra, stdin) != NULL) //estamos  validando si mi entrada es un tipo de letra ó es un numero
        {
            ...
            noNum = false;
            if (strlen(letra) == 0) noNum = true;
            for (n=0; n<strlen(letra); n++) if (!isdigit(letra[n])) noNum = true;
...
bool Arbitro::validarIntento(int fila, int columna)
{
    ...
    while (juegoEnCurso)
    {
        ...
        while (!validar)
        {
            cout<< "\250En que columna esta la bolita?: "<< endl;//pregunta al ususario en que columna cree que esta la bolita
            if (fgets (letra, sizeof letra, stdin) != NULL) //estamos  validando si mi entrada es un tipo de letra ó es un numero
            {
                letra[strlen(letra)-1] = '\0';
                noNumero = false;
    ...
    if (fila-1 == filaBolita && columna-1 == columnaBolita)//cuando la posiscion ingresada por el usuario es correcta
    {
        ...
        cout<<"..........................................................."<<endl;//imagen de un trofeo como señal de que el jugador ganó
        ...
        cout <<" Su intento es fallido puntaje actual: "<<puntaje <<"puntos"<< endl<<endl;//en caso de que el intento sea fallido muestra la puntuacion actual del jugador
